...
def parse_opt():
        ...
        parser.add_argument('--mode', type=str, default='split', help='Spliting mode: split or merge')
        parser.add_argument('--method', type=str, default='copy', help='Moving type: cut or copy')
